...
const About = () => {
  return (
    <section id='about' className='text-center text-gray-700 font-roboto p-8'>
      ...
      <div className="flex flex-wrap gap-10 justify-center px-2 md:px-4">
        ...
        <p className="text-start text-xl max-w-xl leading-relaxed border-2">
          ...
          <span className="block text-xl font-medium border-b-2 p-1 my-4 border-blue-600 hover:bg-blue-600 hover:text-white w-fit italic text-black">
