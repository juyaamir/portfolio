...
{/* 
      ...
      <div>
        <Link to='https://drive.google.com/file/d/1VJJseYsfq1Lu0uZdTaqgFPocZj_0P1oF/view?usp=drive_link' target="_blank">
          <button type="submit" className="btn text-blue-500 text-lg font-bold  border-2 border-blue-500 bg-white hover:bg-blue-500 hover:text-white px-6  
          rounded mt-10 hover:scale-110 duration-500 button-size">
            My CV
          </button>
        </Link>
      </div>
